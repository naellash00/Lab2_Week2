...
public class Java_Lab2 {
    public static void main(String[]args){
        ...
        int k = 3, largestElement = theFullArray[0];
        int [] kLargestElements = new int[k];
        for(int i = 0; i < theFullArray.length; i++) {
            if(theFullArray[i] > largestElement){
                largestElement = theFullArray[i];
                for (int j = 0; j < kLargestElements.length; j++) {
                    kLargestElements[j] = theFullArray[i];
                }
            }
        }
        for (int i = 0; i < kLargestElements.length; i++) {
            System.out.print(kLargestElements[i] + " ");
        }
        System.out.println();
        ...
        do{
            ...
            switch(menuOption){
                ...
                case 3: System.out.println("Enter a number to find if its in the array: ");
                   ...
                   break;
                case 4: System.out.println("The sorted array: ");
                    for (int i = 0; i < menuArray.length; i++) {
